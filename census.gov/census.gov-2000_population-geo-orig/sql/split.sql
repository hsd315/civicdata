...
FROM geofile WHERE sumlev =  20 and chariter = 0 and geocomp = 0 ;
...
arealand, areawatr, pop100, hu100, intptlat, intptlon, gcuni,lsadc, trim(name) as name
FROM geofile WHERE sumlev =  30  and chariter = 0 and geocomp = 0 ;
...
SELECT DISTINCT region, division, state, statece, county, 
arealand, areawatr, pop100, hu100, intptlat, intptlon, gcuni,lsadc, trim(name) as name
...
SELECT DISTINCT region, division, state, statece, county, countysc, cousub, cousubcc, cousubsc, 
arealand, areawatr, pop100, hu100, intptlat, intptlon, gcuni,lsadc, trim(name) as name
...
SELECT DISTINCT region, division, state, statece, county, countysc, tract, 
arealand, areawatr, pop100, hu100, intptlat, intptlon, gcuni,lsadc, trim(name) as name
...
SELECT DISTINCT region, division, state, statece, county, countysc, tract, blkgrp,
arealand, areawatr, pop100, hu100, intptlat, intptlon, gcuni,lsadc, trim(name) as name
...
SELECT DISTINCT region, division, state, statece, place, placecc, placedc, placesc,exi, msacmsa,masc,cmsa,macci,pmsa
arealand, areawatr, pop100, hu100, intptlat, intptlon, gcuni,lsadc, trim(name) as name
