...
region, division, state, statens, county, countyns
arealand, areawatr, pop100, hu100, intptlat, intptlon, gcuni,lsadc, trim(name) as name
...
region, division, state, statens, county, countyns, countysc, cousub, cousubcc, cousubsc, 
arealand, areawatr, pop100, hu100, intptlat, intptlon, gcuni,lsadc, trim(name) as name
...
region, division, state, statens, county, countyns, countysc, tract, 
arealand, areawatr, pop100, hu100, intptlat, intptlon, gcuni,lsadc, trim(name) as name
...
region, division, state, statens, county, countyns, countysc, tract, blkgrp,
arealand, areawatr, pop100, hu100, intptlat, intptlon, gcuni,lsadc, trim(name) as name
...
SELECT DISTINCT 
'16000US' || substr('00'||state,-2,2) || substr('00000'||place,-5,5) as geoid, 
region, division, state, statens, place, placens, placecc,placesc,gcuni,lsadc,  trim(name) as name
